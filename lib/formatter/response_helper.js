...
class ResultKlass {
   ...
   * @param errorConfig.param_error_config - param error info
   */
  renderResponse(responseObj, errorConfig) {
    const oThis = this;
   ...
   * @return {object}
   */
  _fetchParamErrorDetails(paramErrorCode) {
    const oThis = this;
